...
set(_vtk_installed_prefix "D:/work/libs/VTK_x64_DEBUG_BIN/lib/cmake/vtk-8.2")
...
if (_vtk_installed_prefix_full STREQUAL _vtk_requested_prefix_full)
  set(VTK_INSTALL_PREFIX "D:/work/libs/VTK_x64_DEBUG_BIN")
else ()
...
if (__vtk_install_tree)
  if (WIN32)
    set (VTK_RUNTIME_DIRS "D:/work/libs/VTK_x64_DEBUG_BIN/bin")
  else ()
    set (VTK_RUNTIME_DIRS "D:/work/libs/VTK_x64_DEBUG_BIN/lib")
  endif ()
else()
  if (WIN32)
    set (VTK_RUNTIME_DIRS "D:/work/libs/buildVTK_x64_DEBUG/bin")
  else ()
    set (VTK_RUNTIME_DIRS "D:/work/libs/buildVTK_x64_DEBUG/lib")
  endif ()
endif()

...
# define VXL_COMPILER_IS_CrayClang 0
...
# define VXL_COMPILER_IS_Tasking 0
# define VXL_COMPILER_IS_OrangeC 0
...
# define VXL_COMPILER_IS_TIClang 0
...
# undef VXL_COMPILER_IS_CrayClang
# define VXL_COMPILER_IS_CrayClang 1
...
# undef VXL_COMPILER_IS_Tasking
# define VXL_COMPILER_IS_Tasking 1

#elif defined(__ORANGEC__)
# undef VXL_COMPILER_IS_OrangeC
# define VXL_COMPILER_IS_OrangeC 1
...
# undef VXL_COMPILER_IS_TIClang
# define VXL_COMPILER_IS_TIClang 1
